...
var options = {
  ...
  pythonOptions: ['-u'],
  scriptPath: '/home/ubuntu/Documents',
  args: ['value1', 'value2', 'value3']
};

PythonShell.run('surf.py', options, function (err, results) {
  if (err) throw err;
              ...
              // the text field was used, so process the input type=text with regular node/express
                ...
                if (urlParsed.pathname){
                  ...
                  download(urlParsed.href, newFilename, function () {
                    ...
                    res.end("<h1>Uploaded from URL</h2><img style='max-width:100%' src='" + wholePath + "'/><pre>" + reqJSON + "</pre><a href='/'>Go back</a>")
